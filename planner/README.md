...
Currently, we are in MPC mode and in order to switch to Pure Pursuit mode, you will need to change the parameter `control_mode` in the file `config/params.yaml`
